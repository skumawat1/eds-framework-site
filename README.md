...
- [ ] AEM Sites console → Create → Site from template
  - Title: **Eds Framework Site** · Name: **eds-framework-site** · GitHub: https://github.com/skumawat1/eds-framework-site
- [ ] Open Universal Editor → verify authoring → Quick Publish all pages
- [ ] Verify https://main--eds-framework-site--skumawat1.aem.page
